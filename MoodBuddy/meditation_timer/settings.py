...
SECRET_KEY = 'django-insecure-7^mcb_c3)1^(9fw2t2bbuc(_7ca2*_y8ig6c$d_2!sbnibzsvm'
...
CORS_ALLOW_ALL_ORIGINS = True  # Prevent conflicts
CORS_ALLOWED_ORIGINS = ["http://localhost:5173"]  # Allow frontend explicitly
CORS_ALLOW_CREDENTIALS = True  # Required for cookies, session auth
